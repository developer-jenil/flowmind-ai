...
exports.runWorkflowSimulation = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const runWorkflowSimulation = async (workflowId, nodesJson, edgesJson, broadcast) => {
    ...
    const logs = [];
    const addLog = (nodeId, type, message, data) => {
        const logItem = {
...
exports.runWorkflowSimulation = runWorkflowSimulation;
