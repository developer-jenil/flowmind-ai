...
exports.getAgentResponse = exports.generateWorkflowFromPrompt = void 0;
...
Lay out nodes left-to-right (incrementing X coordinates by ~250px, keep Y stable around ~150-250px) sequentially.`
    ...
    const edges = [];
    let step = 0;
    const addNode = (type, label, extraData = {}) => {
...
exports.generateWorkflowFromPrompt = generateWorkflowFromPrompt;
const getAgentResponse = async (agentPrompt, message, history) => {
    if (openai) {
        try {
            const messages = [
